...
plotData <- aggregate(Emissions ~ year, data = fipsB, FUN = "sum")
# Build the plot
png("plot2.png")
plot(plotData$year, plotData$Emissions, type = "b", col = "blue", lwd = 2, xlab = "Year", ylab="Emissions", main = "Total PM25 emissions in the city of Baltimore over time")
dev.off()
